$(document).ready(function () {
    ...
    const form = $("#academicQualificationForm");
    const modal = $("#academicQualificationModal");
    const submitButton = form.find("#submitButton");
    const modalTitle = $("#academicQualificationModalLabel");
    ...
    function renderRow(type) {
        return `
            <tr id="row-${type.id}">
                ...
                <form class="d-inline delete-form" action="/dashboard/academic_qualifications/${type.id}" method="POST" data-id="${type.id}">
    ...
    modal.on("hidden.bs.modal", function () {
        ...
        form.attr("action", "/dashboard/academic_qualifications");

        modalTitle.text('إضافة مؤهل علمي جديد');
